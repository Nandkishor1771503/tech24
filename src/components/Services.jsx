  ...
  return (
    <>
      <div className="cards2 m-auto lg:my-40 lg:w-[60%] w-[80%] text-orange-500  ">
        ...
        <div className="ani sticky h-[80vh]  flex flex-col gap-10 mt-10 p-16 pb-14 rounded-2xl bg-[#181818] ">
          <div className="flex gap-2 text-5xl">
            {" "}
            <span className="font-londrina shadow-xl p-3">02.</span>
            <h2 className="font-londrina font-medium shadow-xl p-3">UI/UX design selection</h2>
          </div>
          <h2 className="text-3xl mt-6 leading-[3.2rem]">
        ...
        <div className="ani sticky h-[80vh]  flex flex-col gap-10 mt-10 p-16 pb-14 rounded-2xl bg-[#181818] ">
          <div className="flex gap-2 text-5xl">
            ...
            <h2 className="font-londrina font-medium shadow-xl p-3">Hosting & deployment</h2>
          </div>
          <h2 className="text-3xl mt-6 leading-[3.2rem]">
        ...
        <div className="ani sticky h-[65vh]  flex flex-col gap-10 mt-10 p-16 pb-14 rounded-2xl bg-[#181818] ">
          <div className="flex gap-2 text-5xl">
            {" "}
            <span className="font-londrina shadow-xl p-3">04.</span>
            <h2 className="font-londrina font-medium shadow-xl p-3">Maintenance and Support</h2>
          </div>
          <h2 className="text-3xl mt-6 leading-[3.2rem]">
          Regularly updating, monitoring, and maintaining websites to ensure optimal performance and security.
